...
function setupMotion() {
  ...
  scrollStyle.textContent = `.project-description span{display:block}.project-description span+span{margin-top:1.3em}.project-gallery.card-carousel{display:flex;max-width:none;overflow-x:auto;overscroll-behavior-x:contain;scroll-snap-type:x mandatory;scrollbar-width:none;gap:18px;padding:26px max(8vw,32px) 32px;cursor:grab;perspective:1200px}.project-gallery.card-carousel.is-dragging{cursor:grabbing;scroll-snap-type:none}.project-gallery.card-carousel::-webkit-scrollbar{display:none}.project-gallery.card-carousel img{flex:0 0 min(52vw,620px);width:min(52vw,620px);grid-column:auto!important;aspect-ratio:4/5!important;object-fit:cover;scroll-snap-align:center;opacity:.28;transform:scale(.8);filter:grayscale(1);transition:transform .75s cubic-bezier(.22,.61,.36,1),opacity .6s ease,filter .6s ease;animation:none;user-select:none}.project-gallery.card-carousel img.is-current{opacity:1;transform:scale(1);filter:grayscale(0);z-index:2}.project-gallery.card-carousel img.is-left{opacity:.58;transform:scale(.88) rotateY(18deg);transform-origin:right center}.project-gallery.card-carousel img.is-right{opacity:.58;transform:scale(.88) rotateY(-18deg);transform-origin:left center}@media(max-width:700px){.project-gallery.card-carousel{gap:12px;padding:18px 9vw 28px}.project-gallery.card-carousel img{flex-basis:76vw;width:76vw;transform:scale(.84)}.project-gallery.card-carousel img.is-left{transform:scale(.9) rotateY(13deg)}.project-gallery.card-carousel img.is-right{transform:scale(.9) rotateY(-13deg)}}`;
